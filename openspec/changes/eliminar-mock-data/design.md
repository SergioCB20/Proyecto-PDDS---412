...
**Non-Goals:**
- No se modifica el backend (controllers, services, repositories)
...
- **[Riesgo bajo] Página en blanco al cargar**: Al iniciar con arrays vacíos, la página mostrará selects sin opciones hasta que `fetchData()` complete. Ya hay polling cada 5s que carga los datos automáticamente.
